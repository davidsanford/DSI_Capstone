...
\begin{frame}{Tweet-Cleaning}
  ...
  \begin{multicols}{2}
  \begin{itemize}
  \item \textcolor{red}{Retweet references}
  \item \textcolor{green}{Hashtags}
  \item User references
  \item Emojis
  \item \textcolor{blue}{Links}
  \item \textcolor{violet}{Keywords}
  \item Proper names
  \item \textcolor{gold}{Garbage strings}
  \end{itemize}
  \end{multicols}
...
\begin{frame}{Topic/Genre Modeling of Video Game Tweets}
  \begin{center}
    ...
    \uncover<2->{\textcolor{blue}{Two disctince methodologies}}
